...
-(QSTodoService *)init
{
    ...
    if (self)
    {
        ...
        MSClient *client = [MSClient clientWithApplicationURLString:@"<your_apps_url>"
                                                     applicationKey:@"<your_azure_app_key>"];
        
        // Add a Mobile Service filter to enable the busy indicator
        self.client = [client clientWithFilter:self];
        
        // Create an MSTable instance to allow us to work with the <your_db_table_name> table
        self.table = [_client tableWithName:@"<your_db_table_name>"];
